...
function BorderRadius(){
    return (
        <>
        <button className="border border-orange-300 text-orange-300 
                           px-4 py-2 ml-4 rounded-l-2xl bg-blue-950"> Klik Saya </button>
        <button className="border border-orange-300 text-orange-300 
                           px-4 py-2 ml-4 rounded-r-2xl bg-blue-950"> Klik Saya </button>
        </>
